...
export const Header: React.FC<HeaderProps> = (props: HeaderProps) => {
    ...
    return (
        <header className={`top-0 fixed w-full z-50 transition-colors duration-500 
                ${isScrolled ? 'bg-gray-900-transparent shadow-gray-50'
                : 'md:bg-transparent md:shadow-none lg:bg-transparent lg:shadow-none bg-gray-900-transparent shadow-gray-50'}`}>
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="shrink-0 mr-4">
                        ...
                        <Link to="/" className="block" aria-label="Cruip">
                            <svg className={`w-8 h-8 fill-current ${isScrolled 
                            ? 'text-blue-600 hover:text-gray-200' 
                            : 'md:hover:text-blue-600 md:text-gray-200 lg:hover:text-blue-600 lg:text-gray-200 text-blue-600 hover:text-gray-200 '}`} 
