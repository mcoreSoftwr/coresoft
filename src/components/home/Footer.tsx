    ...
    <footer className="footer bg-gray-900 text-white p-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-center mb-10">
        <div className="flex flex-col items-center">
          <img src={logoUrl} alt="Logo" className="h-16 w-16 mb-3" />
          <p className="text-center">
            Core Software.<br />Soluciones tecnológicas a medida
          </p>
        </div>
        <div>
      ...
      <div className="text-center">
        <p className="text-white">
          &copy; 2023
          <span className="text-gray-300 font-bold">Core Software.</span> Todos
